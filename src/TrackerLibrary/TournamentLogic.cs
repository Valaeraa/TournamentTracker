...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        // Check if it is big enough - if not, add in byes(auto win) - 2*2*2*2 - 2^4
        ...
        public static void AlertUseersToNewRound(this TournamentModel model)
        {
            ...
            // Loop through each round and get the first List<MatchupModer> that matches the currentRoundNumber
        ...
        {
            return teams.OrderBy(c => Guid.NewGuid()).ToList();
        }
    }
}
